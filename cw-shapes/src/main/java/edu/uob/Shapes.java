...
public class Shapes {
 ...
 public static void main(String[] args) {
  ...
  for(int i = 0; i < 100; i++) {
   if(TwoDShapesA[i] instanceof Triangle) {
    System.out.println("No. of Triangles = " + Triangle.getNTriangles());
    break;
   }
  }
  for(int i = 0; i < 100; i++){
   if(TwoDShapesA[i] instanceof Triangle currShape){
    System.out.println(currShape.getVariant());
   }
  }
 }
}
